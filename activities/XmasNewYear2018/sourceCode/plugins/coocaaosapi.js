cordova.define("com.coocaaosapi", function(require, exports, module) {
    ...
    CoocaaOSApi.prototype.startUserSettingAndFinish4 = function(success, error) {
        argscheck.checkArgs('ff', 'CoocaaOSApi.startUserSettingAndFinish', arguments);
        startapp.check("com.tianci.user", function(message) { /* success */
            startapp.start([["skyworth.useaartest", ""],[{ 'needFinish': true }]], success, error);
        }, error);
    }
    /*
    ...
    CoocaaOSApi.prototype.startMovieListT = function(listid,sort,filter,success,error){
       	argscheck.checkArgs('sssff','CoocaaOSApi.startMovieList',arguments);
       	startapp.start([["action", "coocaa.intent.movie.list"],[{'id':listid},{'sort':sort},{'filter':filter}]], success,error);
  	}
    /*
     * 启动影视详情页
     */
    ...
    /**启动教育影视会员中心*/
    CoocaaOSApi.prototype.startMovieMemberCenter3 = function(type, id, success, error) {
