        ...
        success: function(data){
            ...
            if(code == 50100){
                ...
                /*if(localStorage.getItem("userAddress")){
                    ...
                    $("#affirmBack").css('display', 'none');
                    var userAddress = JSON.parse(localStorage.getItem("userAddress"));
                    console.log('userAddress',userAddress);
                    $('.this_name').text(userAddress.dataName);
                    $('.this_tel').text(userAddress.dataPhone);
                    $('.this_addr').text(userAddress.dataAddress);
                    dataName = userAddress.dataName;
                    dataPhone = userAddress.dataPhone;
                    dataAddress = userAddress.dataAddress;
                    console.log("---dataName---"+dataName+"---dataPhone---"+dataPhone+"---dataAddress---"+dataAddress);
                }else{
