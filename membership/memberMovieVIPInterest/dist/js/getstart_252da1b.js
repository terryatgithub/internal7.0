...
function processKey() {
	...
	}else if(elId == "fourKGarden") {
		console.log("4KGarden purchase");
		//4K花园单独处理
...
function updateInfoBySource(src) {
	...
	if(src == "tencent"){//页面默认是腾讯
		var pic = app.rel_html_imgpath("../img/movieVIPTencent_5136e86.png");
		$(".vipPrivilegeDetails").css("background-image", "url("+pic+")");
//		$("#vf1").css("display", "block");
	}else { //if(src == "yinhe") //对不是腾讯的,默认用yinhe
		var pic = app.rel_html_imgpath("../img/movieVIPIqiyi_2e994bc.png");
		$(".vipPrivilegeDetails").css("background-image", "url("+pic+")");
