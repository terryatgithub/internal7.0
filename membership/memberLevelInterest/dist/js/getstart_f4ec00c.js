...
_levelInfos = [
	 {
	 	level:1, 
	 	levelName:"等级礼包", 
	 	picNormal: "../img/lv1_76d9c33.png", 
	 	picBig: "../img/lv1big_6d3c3e2.png",
	 	picDisabled: "../img/lv1disabled_0f32cb0.png",
	 	levelCondition:"Lv.1 (含) 以上可解锁", 
	 	levelDes:"不同等级会员尊享不同的福利特权，当您的等级提升时，还会赠送您不同级别的升级礼包，等级越高能尊享的权益越多、价值越高，赶快提升等级享受更多福利吧~"
	 }
	,{
		level:1, 
	 	picNormal: "../img/lv12_31c45b0.png", 
	 	picBig: "../img/lv12big_cde6b35.png",
	 	picDisabled: "../img/lv12disabled_06f9021.png",
		levelName:"线上活动", 
		levelCondition:"Lv.1 (含) 以上可解锁", 
	...
	,{
		level:3,
	 	picNormal: "../img/lv3_d534f33.png", 
	 	picBig: "../img/lv3big_31b065f.png",
	 	picDisabled: "../img/lv3disabled_6a5f044.png",
		levelName:"线下活动", 
	...
	,{
		level:5,
	 	picNormal: "../img/lv5_898762a.png", 
	 	picBig: "../img/lv5big_e9dcc99.png",
	 	picDisabled: "../img/lv5disabled_457a874.png",
		levelName:"专属客服", 
	...
	,{
		level:6,
	 	picNormal: "../img/lv6_16a1f93.png", 
	 	picBig: "../img/lv6big_c009ca9.png",
	 	picDisabled: "../img/lv6disabled_a0247a1.png",
		levelName:"专属主题", 
	...
	,{
		level:7, 
	 	picNormal: "../img/lv7_5bf6868.png", 
	 	picBig: "../img/lv7big_fa5a882.png",
	 	picDisabled: "../img/lv7disabled_5802e3e.png",
		levelName:"定制屏保", 
