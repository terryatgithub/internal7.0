cordova.define("com.coocaaosapi", function(require, exports, module) {
 ...
 CoocaaOSApi.prototype.startMovieMemberCenter2 = function(source_id, success, error) {
	...
	CoocaaOSApi.prototype.startAppShopZone2 = function(id,success,error){
	    argscheck.checkArgs('sff','CoocaaOSApi.startAppShopZone',arguments);
	    startapp.start([["action", "coocaa.intent.action.MALL_DETAIL"],[{"pageId":id}]], success,error);
	}
	//启动酷开商城专题页3
	CoocaaOSApi.prototype.startAppShopZone3 = function(id,success,error){
	    argscheck.checkArgs('sff','CoocaaOSApi.startAppShopZone',arguments);
...
//启动通用action
    ...
    CoocaaOSApi.prototype.startNewBrowser3 = function(url, success, error) {
        argscheck.checkArgs('sff', 'CoocaaOSApi.startNewBrowser3', arguments);
    ...
    CoocaaOSApi.prototype.startNewBrowser2 = function(url, success, error) {
        ...
        startapp.start([["action", "coocaa.intent.action.browser.no_trans", "com.coocaa.app_browser", "", "", task + ""],[{ "url": url }]], success, error);
    }
    ...
    CoocaaOSApi.prototype.startRedGame = function(chance,userKeyId,success,error){
     ...
     CoocaaOSApi.prototype.startGameCenterEnd = function(success, error) {
        argscheck.checkArgs('ff', 'CoocaaOSApi.startGameCenterEnd', arguments);
        startapp.start([
            ["action", "coocaa.intent.action.ie.games.quit"]
        ], success, error);
    }
